...
require (
	...
	github.com/evmos/evmos-ledger-go v0.0.3
...
require (
	...
	github.com/evmos/ethereum-ledger-go v0.0.3 // indirect
...
replace (
	...
	github.com/cosmos/cosmos-sdk => github.com/evmos/cosmos-sdk v0.45.7
